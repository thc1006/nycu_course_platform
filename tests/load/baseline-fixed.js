/**
 * K6 Baseline Load Test - FIXED VERSION
 *
 * Purpose: Establish performance baseline for NYCU Course Platform
 * Duration: 5 minutes
 * Virtual Users: 20 concurrent users
 *
 * IMPORTANT: This version includes trailing slashes for all FastAPI endpoints
 * to prevent 307 redirects which k6 does not follow by default.
 */
...
export default function () {
  ...
  // Test 2: Get Semesters (FIXED: Added trailing slash)
  ...
  // Test 3: Get Courses (FIXED: Added trailing slash)
  ...
  // Test 4: Search Courses (FIXED: Added trailing slash)
  ...
  // Test 5: Get Specific Course (already correct, FastAPI handles single resources without trailing slash)
